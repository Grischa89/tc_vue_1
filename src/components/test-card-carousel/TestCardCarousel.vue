...
<script>
import TestCarouselSlide from './TestCarouselSlide.vue';
import TestCarouselControls from './TestCarouselControls.vue';

export default {
  name: 'TestCardCarousel',
  ...
  computed: {
    unevenCodes() {
      ...
      if (this.testCodes.length % 2 === 0) {
        console.log('This array\'s length is an even number!');
        return this.testCodes.slice(0, -1);
      } else {

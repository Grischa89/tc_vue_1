<template>
  <footer class="footer" :class="{ 'footer--with-cta': !userExists }">
    ...
    <div class="footer__container">
      ...
      <div class="footer__container__item">
        <svg xmlns="http://www.w3.org/2000/svg" class="footer__container__item__prepend" viewBox="0 0 20 20" fill="currentColor" aria-labelledby="footer-statement">
          <title id="footer-statement">Footer statement</title>

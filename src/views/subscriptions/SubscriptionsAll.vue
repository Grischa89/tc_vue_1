<template>
  <div v-if="subscriptions" class="subscription">
    ...
    <div v-for="(subscription, i) in subscriptions" :key="i" class="subscription__item">
      <div class="subscription__item__display" :data-subscription-id="subscription.pk">
        ...
        <div class="subscription__item__display__actions">
          <button class="subscription__item__display__actions__btn" @click="showEditForm($event, subscription)">
            <svg xmlns="http://www.w3.org/2000/svg" class="subscription__item__display__actions__btn--edit" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" aria-labelledby="edit-subscription">
      ...
      <!-- :class="{'subscription__item__edit--show': editing }" -->

    ...
    <div class="profile">
        ...
        <div v-if="user && !user.is_active" class="user__info">
         ...
         <div class="profile__nav">
            <div  @click="scrollToActiveTab('overview')" class="profile__nav__tab" :class="{'profile__nav__tab--active': activeTab === 'UserOverview'}" data-tab="overview"><router-link to="/profiletest">Overview</router-link></div>
            <div  @click="scrollToActiveTab('codes')" class="profile__nav__tab" :class="{'profile__nav__tab--active': activeTab === 'UserCodes'}" data-tab="codes"><router-link to="/profiletest/codes">Codes</router-link></div>
            <div  @click="scrollToActiveTab('subscriptions')" class="profile__nav__tab" :class="{'profile__nav__tab--active': activeTab === 'UserSubscriptions'}" data-tab="subscriptions"><router-link to="/profiletest/subscriptions">Subscriptions</router-link></div>
